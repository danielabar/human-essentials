...
RSpec.shared_examples_for "Date Range Picker" do |described_class, date_field|
  ...
  context "when entering an invalid date range" do
    ...
    it "shows a flash notice and filters results as default" do
      ...
      # TODO: 4922 - could be issue if more than one submit button, try to restrict by "Filter" text
      page.execute_script("document.querySelector('button[name=\"button\"][type=\"submit\"]').click();")
    ...
    it "shows a JavaScript alert when user blurs" do
      ...
      # verify user can fix the issue using litepicker and move on
